...
# ==================== CONFIGURATION ====================
API_ID = int(os.getenv("API_ID", "25790571"))
API_HASH = os.getenv("API_HASH", "2b95fb1f6f630a83e0712e84ddb337f2")
BOT_TOKEN = os.getenv("BOT_TOKEN", "8131822434:AAFMdfVtuZh5Nc2iaFW-RfoMbw36cn4lO2A")
OWNER_IDS = [6580618549]
ALLOW_DIRECT_IP = os.getenv("ALLOW_DIRECT_IP", "False").lower() == "true"  # پیش‌فرض: غیرفعال
...
# قفل‌های async برای هر session
session_locks = {}
# قفل برای جلوگیری از اجرای هم‌زمان چند عملیات برای یک کاربر
...
DEVICE_MODELS = [
    ...
    {"app_version": "10.10.5", "device_model": "OnePlus 11", "system_version": "Android 14", "lang_code": "en"},
    {"app_version": "10.9.3", "device_model": "Samsung Galaxy S23", "system_version": "Android 14", "lang_code": "fa"},
    {"app_version": "10.8.1", "device_model": "Huawei P60", "system_version": "Android 13", "lang_code": "en"},
    {"app_version": "10.12.0", "device_model": "iPhone 13", "system_version": "iOS 16.6", "lang_code": "en"},
    {"app_version": "10.7.4", "device_model": "Xiaomi Redmi Note 12", "system_version": "Android 13", "lang_code": "fa"},
# ===== 20 دستگاه جدید =====
{"app_version": "10.14.0", "device_model": "Samsung Galaxy S21 FE", "system_version": "Android 13", "lang_code": "en"},
{"app_version": "10.13.5", "device_model": "Samsung Galaxy A54", "system_version": "Android 14", "lang_code": "fa"},
{"app_version": "10.12.3", "device_model": "Samsung Galaxy Note 20 Ultra", "system_version": "Android 13", "lang_code": "ar"},
{"app_version": "10.11.8", "device_model": "Samsung Galaxy M53", "system_version": "Android 13", "lang_code": "en"},
{"app_version": "10.10.2", "device_model": "Samsung Galaxy Z Flip 5", "system_version": "Android 14", "lang_code": "tr"},
{"app_version": "10.9.7", "device_model": "Samsung Galaxy S22", "system_version": "Android 14", "lang_code": "fa"},
{"app_version": "10.8.5", "device_model": "Samsung Galaxy A34", "system_version": "Android 13", "lang_code": "en"},
{"app_version": "10.7.9", "device_model": "Samsung Galaxy Tab S8", "system_version": "Android 13", "lang_code": "ru"},
{"app_version": "10.6.3", "device_model": "Samsung Galaxy S21", "system_version": "Android 12", "lang_code": "en"},
{"app_version": "10.5.1", "device_model": "Samsung Galaxy Note 10+", "system_version": "Android 12", "lang_code": "fa"},
{"app_version": "10.14.1", "device_model": "iPhone 12 Pro", "system_version": "iOS 16.7", "lang_code": "en"},
{"app_version": "10.13.2", "device_model": "Xiaomi 12T", "system_version": "Android 13", "lang_code": "fa"},
{"app_version": "10.12.4", "device_model": "Huawei P50", "system_version": "Android 12", "lang_code": "ar"},
{"app_version": "10.11.6", "device_model": "OnePlus 10 Pro", "system_version": "Android 14", "lang_code": "en"},
{"app_version": "10.10.8", "device_model": "Google Pixel 7", "system_version": "Android 14", "lang_code": "tr"},
{"app_version": "10.9.1", "device_model": "Sony Xperia 5 IV", "system_version": "Android 13", "lang_code": "fa"},
{"app_version": "10.8.9", "device_model": "Nokia X30", "system_version": "Android 13", "lang_code": "en"},
{"app_version": "10.7.2", "device_model": "Motorola Edge 40", "system_version": "Android 13", "lang_code": "ru"},
{"app_version": "10.6.5", "device_model": "iPhone 11", "system_version": "iOS 16.5", "lang_code": "en"},
{"app_version": "10.5.7", "device_model": "Realme GT Neo 3", "system_version": "Android 13", "lang_code": "fa"},
]
...
def reason_to_bytes(reason):
    """Convert InputReportReason to bytes for ReportRequest option."""
    # In Telethon, option expects bytes; we can serialize the TLObject constructor id
    return struct.pack('<I', reason.CONSTRUCTOR_ID)

async def get_session_lock(session_key):
...
async def perform_report(client, entity, reason, message, count=1, msg_ids=None, retries=2):
    ...
    for i in range(count):
        ...
        while attempt <= retries:
            try:
                if msg_ids:
                    msg_list = msg_ids if isinstance(msg_ids, list) else [msg_ids]
                    for msg_id in msg_list:
                        await client(ReportMessageRequest(
                            peer=entity,
                            id=[msg_id],
                            option=reason_to_bytes(reason),
                            message=message
                        ))
                else:
...
async def execute_report_operation(event, state, user_id, lang):
    ...
    custom_reasons = state.get("custom_reasons", [])
    if custom_reasons:
        custom_reasons = [r for r in custom_reasons if r and r != "/skip"]
    ...
    for idx, (admin_id_str, filename) in enumerate(sessions, 1):
        # انتخاب تصادفی متن برای این اکانت
        custom_msg = random.choice(custom_reasons)
        ...
        # قفل مخصوص این session
        session_key = f"{admin_id_str}_{filename}"
        lock = await get_session_lock(session_key)
        async with lock:
            # انتخاب پروکسی: تست تمام پروکسی‌ها و انتخاب اولین موفق؛ در صورت نبود پروکسی، اگر ALLOW_DIRECT_IP باشد مستقیم
            proxy_used = None
            proxy_str = "آی‌پی مستقیم سرور"
            if has_proxies:
                for p in proxies_list:
                    try:
                        test_client = TelegramClient(StringSession(session_str), API_ID, API_HASH, proxy=p)
                ...
                if proxy_used is None:
                    if ALLOW_DIRECT_IP:
                        ...
                        # بدون پروکسی و اجازه مستقیم نداریم: این اکانت را رد می‌کنیم
                        total_fail += count_per_account
                        errors_list.append(f"{filename}: No working proxy available")
                        continue
            else:
                if not ALLOW_DIRECT_IP:
                    total_fail += count_per_account
                    errors_list.append(f"{filename}: Direct IP not allowed and no proxy configured")
                    continue
                    ...
                    if op_type == "report_post":
                        ...
                        if post_links:
                            for link in post_links:
                                ...
                                if not match:
                                    total_fail += count_per_account
                                    errors_list.append(f"{filename} (Post {link}): Invalid link")
                                    continue
                            ...
                            try:
                                ...
                                for msg in messages:
                                    try:
                                        ...
                                        # خطا در یک پیام، بقیه ادامه می‌یابد
                                        total_fail += count_per_account
                                        errors_list.append(f"{filename} (Post {msg.id}): {str(e)[:40]}")
                            except Exception as e:
                                total_fail += (post_count * count_per_account)
                        ...
                        if not photos:
                            total_fail += count_per_account
                            errors_list.append(f"{filename}: No profile photo found")
                        else:
                            photo = photos[0]
                            for _ in range(count_per_account):
                                try:
                                    ...
                                    total_fail += 1
                                    logger.warning(f"FloodWait in profile report: {e.seconds}")
                                    await asyncio.sleep(min(e.seconds, 60))
                                except Exception as e:
                                    total_fail += 1
                                    errors_list.append(f"{filename}: Profile report error: {str(e)[:40]}")
                                await asyncio.sleep(random.uniform(1.0, 3.0))
                    else:
                        target_str = state.get("target", "").strip()
                        clean_target = target_str.replace("https://t.me/", "").replace("t.me/", "").replace("@", "")
            ...
            while remaining > 0:
                ...
                try:
                    await status_msg.edit(
                        ...
                        f"⏱ تاخیر هوشمند: {remaining} ثانیه باقی‌مانده..."
                        if lang == "fa" else
                        ...
                        f"⏱ Human Delay: {remaining}s remaining..."
                    )
                except Exception:
                    pass
    ...
    result = (
        ...
        f"ℹ️ این اعداد نشان‌دهنده‌ی ارسال موفق درخواست‌هاست، نه اقدام نهایی تلگرام."
        if lang == "fa" else
        ...
        f"❌ Failed: {total_fail}\n\n"
        f"ℹ️ These numbers indicate successful API requests, not final Telegram action."
    )
    ...
    # اتمام عملیات: پاک‌سازی state کاربر
    ...
    if data == "tg_proxies_list":
        ...
        if not proxies:
            ...
            msg = (f"🌐 **تعداد {len(proxies)} پروکسی فعال آماده استفاده است.**\n\n"
                   f"هر اکانت به صورت تصادفی از بین پروکسی‌های سالم انتخاب می‌کند.") if lang == "fa" else f"🌐 **{len(proxies)} proxies active.**"
    ...
    if flow == "bulk":
        ...
        if step == "body":
            ...
            if not recips:
                ...
                return
            active = admin_data.get("active_senders", [])
            senders = [s for s in smtp_list if s["email"] in active] if active else smtp_list[:]
            if not senders:
                USER_STATE.pop(user_id, None)
                await event.reply("❌ هیچ SMTP فعالی وجود ندارد" if lang == "fa" else "❌ No active SMTP")
                return
            success = 0
            failed = 0
            if len(recips) == 1 and len(senders) > 1:
                target = recips[0]
                for sender in senders:
                    ok, err = await asyncio.to_thread(send_email_sync, sender["email"], sender["password"], target, subject, body)
                    if ok:
                        success += 1
                    else:
                        failed += 1
                        logger.error(f"Bulk send to {target} with {sender['email']} failed: {err}")
                ...
                for idx, r in enumerate(recips):
                    ...
                    if ok:
                        ...
                        failed += 1
                        logger.error(f"Bulk send to {r} with {sender['email']} failed: {err}")
                    await asyncio.sleep(1)
            if success:
                bump_send_counters(data_db, success)
                save_data(data_db)
            total_attempts = len(recips) * (len(senders) if len(recips) == 1 else 1)
            await event.reply(f"✅ تمام شد\n📨 کل: {total_attempts}\n✅ موفق: {success}\n❌ ناموفق: {failed}" if lang == "fa" else f"✅ Done\n📨 Total: {total_attempts}\n✅ Success: {success}\n❌ Failed: {failed}")
            USER_STATE.pop(user_id, None)
            return
...
async def telegram_message_handler(event, state, text, user_id, lang):
    ...
    if step == "count":
        try:
            ...
            if count < 1 or count > len(sessions):
                ...
                return
            state["count"] = count
            # انتخاب تصادفی اکانت‌ها
            if count == len(sessions):
                selected = sessions
            else:
                selected = random.sample(sessions, count)
    ...
    if step == "post_links":
        ...
        for link in lines:
            ...
            if len(post_links) >= 100:
                break
        if skipped > 0:
            await event.reply(f"⚠️ {skipped} لینک نامعتبر نادیده گرفته شد." if lang == "fa" else f"⚠️ {skipped} invalid links skipped.")
        if not post_links:
            await event.reply("❌ هیچ لینک معتبری یافت نشد." if lang == "fa" else "❌ No valid links found.")
            return
    ...
    if step == "count_per_account":
        try:
            ...
            await event.reply("📝 متن دلخواه (حداکثر ۵ متن، هر خط یک متن) یا /skip" if lang == "fa" else "📝 Custom message (up to 5 texts, one per line) or /skip")
        except ValueError:
            await event.reply("❌ عدد وارد کنید" if lang == "fa" else "❌ Enter a number")
        return
    ...
    if step == "custom_reason":
        if text.strip() == "/skip":
            state["custom_reasons"] = [state.get("default_msg", "Reported by user")]
        else:
            ...
            if len(lines) > 5:
                lines = lines[:5]
                await event.reply("⚠️ حداکثر ۵ متن مجاز است، ۵ متن اول ذخیره شد" if lang == "fa" else "⚠️ Max 5 texts allowed, first 5 saved")
            state["custom_reasons"] = lines
        # اجرای عملیات و عدم پاک‌سازی state تا پایان
        asyncio.create_task(execute_report_operation(event, copy.deepcopy(state), user_id, lang))
        # state بعد از اتمام عملیات پاک می‌شود (در انتهای execute_report_operation)
        # اما برای جلوگیری از شروع عملیات جدید، state را نگه می‌داریم تا عملیات تمام شود
        return
